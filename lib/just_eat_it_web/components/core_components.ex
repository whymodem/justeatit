defmodule JustEatItWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(JustEatItWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(JustEatItWeb.Gettext, "errors", msg, opts)
    end
  end
